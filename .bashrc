...
# PS1
export PS1=" \[$(tput setaf 165)\]\u\[$(tput setaf 171)\]@\[$(tput setaf 213)\]\h \[$(tput setaf 219)\]\w \[$(tput sgr0)\]λ "
...
__conda_setup="$('/home/prophet/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/prophet/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/prophet/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/prophet/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
